...
| T-036 | Scouty integration for desktop lease coordination | medium | Cross-tool dependency |
| T-037 | pip publish simemu + install.sh improvements | medium | Distribution |

## Cross-reference with deep analysis

The shared-desktop-plan.md describes a clear reliability gap when humans and agents share the same Mac. Three tasks (T-033, T-034, T-035) directly address this.
...
- Scouty dependency (T-036) may need scouty to be built first — potential blocker
...
5. T-035 + T-036 + T-037 (Reservations, scouty, publish) — lower priority
