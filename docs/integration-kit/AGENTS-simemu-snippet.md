...
**Aliases:** `simemu claim iphone`, `simemu claim ipad`, `simemu claim pixel`, `simemu claim watch`
...
simemu do $SESSION proof -o verified.png --url "myapp://screen"
...
The error message includes the exact re-claim command. Run it:
